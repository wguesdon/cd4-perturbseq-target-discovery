...
abstract: |
  ...
  selectivity requirement and a tolerance-preservation penalty,
...
actually separate the false positives are context selectivity, resting-transcriptome disruption,
and tolerance preservation. All three are computed from the knockdown transcriptome itself. Every
gate axis that was a database membership test has failed here: first DepMap and Hart essentiality,
then the IUIS immunodeficiency list. That is not a coincidence, and it is the project's actual
contribution.
