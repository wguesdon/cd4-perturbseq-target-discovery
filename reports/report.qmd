...
Well-tolerated agents passing the gate: 3 of 3. Narrow-index agents passing: 1 of 2. Five points
is a direction, not a p-value, and we report it as one.
...
`CD3E` now passes. The screen-native axes cannot see cytokine release syndrome, which is why
muromonab was withdrawn. We report the weaker number.
